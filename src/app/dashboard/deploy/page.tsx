...
export default function DeployPage() {
  ...
  return (
    <div className="min-h-screen bg-white p-6">
      <h1 className="text-3xl font-bold mb-4">Your Saved Agents</h1>
      <p className="text-gray-600 mb-8">
        Manage your saved agents. You can rename or delete them.
      </p>
              ...
              <div className="flex items-center gap-4">
                ...
                {editingId === agent._id ? (
                  <input
                    ...
                    className="form-input text-sm border rounded px-2 py-1"
                  />
                ) : (
